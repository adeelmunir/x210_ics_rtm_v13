...
{
	platform_driver_register(&pwm_beeper_driver);
...
static struct platform_device pwm_beeper_device = {
        .name           = "pwm-beeper",
        .id             = -1,
};
...
int ourinitmodule(void)
{
	...
	platform_device_register(&pwm_beeper_device);
	return 0;
}

void ourcleanupmodule(void)
{
	platform_device_unregister(&pwm_beeper_device);
