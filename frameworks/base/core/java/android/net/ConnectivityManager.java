...
public class ConnectivityManager {
    ...
    public boolean isNetworkSupported(int networkType) {
        try {
        	Log.d("FLOW","cm.isNetworkSupported " + networkType);		// added
            return mService.isNetworkSupported(1);		// added 1 instead f networkType
        } catch (RemoteException e) {}
        Log.d("FLOW","cm.isNetworkSupported inside exception " + networkType);		// added
        return false;
    }
}
